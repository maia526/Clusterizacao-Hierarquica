...
public class ClusterizacaoNaive {
    ...
    public ClusterizacaoNaive() throws IOException {
    ...
    public void removerClusteresDaLista(Distancia distancia, List<Cluster> listaCluster){ //todo: não sei se teria problema utilizar aqui uma lista para retirar e não só utilizar dois remove(). Está gastando memória sem precisa, mas é pequena
    ...
    public Distancia acharMenorDistancia(List<Distancia> listaDistancia) {
    ...
    public List<Distancia> calcularDistancias(List<Cluster> listaCluster) {
